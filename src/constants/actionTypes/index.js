...
export const ADD_REMOVE_START_LOADING = "ADD_REMOVE_START_LOADING";
export const ADD_REMOVE_START_SUCCESS = "ADD_REMOVE_START_SUCCESS";
export const ADD_REMOVE_START_ERROR = "ADD_REMOVE_START_ERROR";